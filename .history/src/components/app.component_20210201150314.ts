...
storage.key = storage.key || localStorage?.stripeAngularKey || "pk_test_5JZuHhxsinNGc5JanVWWKSKq"
...
@Component({
  ...
  async save(): Promise<stripe.Stripe>{
    ...
    console.log('this.storage.key',this.storage.key, localStorage.stripeAngularPrivateKey)
